/* Encoder based on wokwi/bmp-ts - https://github.com/wokwi/bmp-ts
 * Adapted to run directly in node by Kiril Vatev
 */
...
module.exports = class BmpEncoder {
  constructor(imgData) {
    ...
    this.colors = Math.min(Math.pow(2, (this.bitPP - 1 || 1)), imgData.colors || Infinity);
